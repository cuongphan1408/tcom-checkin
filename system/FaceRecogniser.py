...
class FaceRecogniser(object):
    ...
    def __init__(self):
        ...
        with open("generated-embeddings/classifier.pkl","rb") as f: # le = labels, clf = classifier
            print("Open file classifier.pkl success", f)
            u = pickle._Unpickler(f)
            u.encoding = 'latin1'
            (self.le, self.clf) = u.load() # Loads labels and classifier SVM or GMM
    ...
    def make_prediction(self,rgbFrame,bb):
        ...
        to align the eyes and nose to the correct position.
        The aligned face is passed through the neural net which
        generates 128 measurements which uniquely identify that face.
    ...
    def recognize_face(self,img):
        ...
        print ("xxxxxxxxxxx____recognize_face____xxxxxxxxxx")
    ...
    def train(self,workDir,classifier,ldaDim):
        ...
        logger.info("Loading labels " + fname + " csv size: " +  str(os.path.getsize("generated-embeddings/reps.csv")))
        ...
        if os.path.getsize(fname) > 0:
            logger.info(fname + " file is not empty")
            embeddings = pd.read_csv(fname, header=None).values # Get embeddings as a matrix from reps.csv
            print("xxxxx")
        else:
            logger.info(fname + " file is empty")
        ...
        if classifier == 'LinearSvm':
            ...
            self.clf = GaussianMixture(n_components=nClasses)
        ...
        fName = "generated-embeddings/classifier.pkl".format(workDir)
        ...
        with open(fName, 'wb') as f:
            ...
            print("success write generated-embeddings/classifier.pkl")
